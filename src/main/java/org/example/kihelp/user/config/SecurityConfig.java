        ...
        http
                ...
                .authorizeHttpRequests(authorizeHttpRequests ->
                        authorizeHttpRequests
                                ...
                                .requestMatchers(HttpMethod.GET, "/api/v1/wallets/wallet/by/{wallet_id}").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.PUT, "/api/v1/wallets/wallet/by/{wallet_id}").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.PUT, "/api/v1/wallets/wallet/by/user/{telegram_id}").hasRole("ADMIN")
